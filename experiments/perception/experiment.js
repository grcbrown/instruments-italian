...
const irb = {
    ...
    stimulus: `
        <div style="font-size: 16px; text-align: center; margin-top: 25px; margin-right: 50px; margin-left: 50px; margin-bottom: 25px;">
            ...
            <h3>DESCRIZIONE</h3>
            <p>Ti invitiamo a partecipare a uno studio di ricerca sulla percezione linguistica. Lo scopo \u00e8 aiutarci a comprendere quali fattori influenzano la costruzione delle frasi. Nel corso dello studio leggerai una serie di frasi e utilizzerai delle scale di valutazione per esprimere le tue opinioni sugli eventi descritti da ciascuna frase. Successivamente, avrai la possibilit\u00e0 di compilare un sondaggio demografico facoltativo. La partecipazione a questa ricerca \u00e8 volontaria e sei libero di revocare il tuo consenso in qualsiasi momento.</p>
            <h3>TEMPO RICHIESTO</h3> 
            <p>La tua partecipazione richieder\u00e0 circa 15 minuti.</p>
            <h3>PAGAMENTI</h3> 
            ...
            <p>Non esiste un limite di tempo per la conservazione dei tuoi Dati dello Studio per questa ricerca, poich\u00e9 potrebbero essere analizzati per molti anni. Conserveremo inoltre i tuoi Dati dello Studio per rispettare i requisiti legali e normativi. Li manterremo finch\u00e9 saranno utili, a meno che tu decida di non voler pi\u00f9 partecipare. Autorizzi l'accesso a queste informazioni a tempo indeterminato, finch\u00e9 non ritirerai il tuo consenso.</p>
            <br>
...
const instructions = {
    ...
    <div class="gen_ins"; style="font-size: 16px; text-align: center; margin-top: 25px; margin-right: 100px; margin-left: 100px; margin-bottom: 25px;">
        <p>Durante questo studio, vedrai una serie di frasi. Ogni frase descriver\u00e0 un evento. Sar\u00e0 seguita da 7 affermazioni. \u00e8 necessario indicare su una scala quanto ciascuna affermazione si applica all'evento. Fare clic sulla scala per rispondere. Ci sono 26 prove e questa parte dello studio dovrebbe richiedere 15 minuti.</p>
...
const transition = {
    ...
    stimulus: `
    <div class="gen_ins"; style="font-size: 16px; text-align: center; margin-top: 25px; margin-right: 100px; margin-left: 100px; margin-bottom: 25px;">
        <p>Hai completato le prove sperimentali. Rispondi alle domande nella pagina successiva a cui desideri rispondere. Dopo aver visualizzato il sondaggio, puoi terminare l'esperimento.</p>
...
const questionnaire = {
  ...
  survey_json: {
    ...
    elements: [
      {
        type: "html",
        html: "<p>Rispondi alle seguenti domande. Una volta completato il sondaggio, clicca su 'Fine' nella parte inferiore della pagina per essere reindirizzato alla fine dell'esperimento.</p>"
      },
      {
        type: "boolean",
        name: "understood",
...
async function createExperiment() {
  const condition = await jsPsychPipe.getCondition("mwEudshD1c7I"); 
